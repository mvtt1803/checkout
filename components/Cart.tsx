...
export default function Cart({
  ...
  return (
    <div className="fixed top-20 right-2 w-[260px] sm:w-[290px] md:w-[320px] max-h-[600px] p-3 bg-white rounded-lg shadow-md text-sm z-50 overflow-hidden">
